...
const DashBoard = () => {
    ...
    return (
        <div className={`${darkModeState && "dark"}`}>
            <div className="  p-4 dark:bg-customBlue flex-grow overflow-hidden ">
            <div className="flex flex-col md:flex-row justify-between border border-solid border-black mt-[102px] ">
                <div className=" flex justify-center  md:w-8/12 border border-solid border-black flex-col">
                    <div className=" text-center ">
                        ...
                        <div className="text-4xl md:text-7xl text-gray-500 my-4 p-2"><span>Don't ask how</span></div>
                ...
                <div className="w-full  md:w-4/12  border border-solid border-black flex justify-center items-center">
